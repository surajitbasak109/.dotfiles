...
#define wal "/home/surajit/.cache/wal/colors-wal-dwm.h"
...
static const char *const autostart[] = {
	...
	"wal", "-n", "-i", "~/wallpaper/12.jpg", NULL,
	"~/.local/bin/setwp", NULL,
	"picom", "--experimental-backend", "--config", "~/.config/picom/picom.conf", NULL,
...
static const char *ss[] = {"scrot", "~/Pictures/screenshots/ss.png", NULL};
static const char *ssp[] = {"scrot", "-s", "~/Pictures/screenshots/ss.png", NULL};
