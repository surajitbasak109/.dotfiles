...
vim.api.nvim_set_keymap('n', '<m-i>', '<cmd>lua _FLOAT_TERM()<CR>', { noremap = true, silent = true })
vim.api.nvim_set_keymap('i', '<m-i>', '<cmd>lua _FLOAT_TERM()<CR>', { noremap = true, silent = true })
